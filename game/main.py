...
#music and sounds
music = pygame.mixer.Sound('game/Ripleys Rescues.mp3')
gameover_music = pygame.mixer.Sound('game/gameover1.wav')
alien_screem = pygame.mixer.Sound('game/hiss2.wav')
explosion_sound = pygame.mixer.Sound('game/explosion.wav')
...
BROWN = (150,150,150)
 #cursor display
new_cursor = pygame.image.load('game/crosshair1.png')
pygame.mouse.set_visible(False)

#image and text variables
back = pygame.image.load('game/back.gif') 
background = pygame.image.load('game/background.png')                                  
font = pygame.font.Font(os.path.join(os.getcwd(), 'game/Robot9000Italic-YzxE8.ttf'), 42)
score_text = font.render('Score : ' + str(score), True, (255, 255, 255))    
lives_icon = pygame.image.load('game/white_lives.png')                    

# aliens positions and when to spawn
def generate_random_aliens(alien):
    alien_path = "game/" + alien + ".png"
    data[alien] = {
...
def hide_cross_lives(x, y):
    gameDisplay.blit(pygame.image.load("game/red_lives.png"), (x, y))

# draw fonts on the screen
def draw_text(display, text, size, x, y):
    font = pygame.font.Font('game/Robot9000Italic-YzxE8.ttf', 60)
...
while game_running :
    if game_over :
        ...
        game_over = False
        player_lives = 3
        draw_lives(gameDisplay, 690, 5, player_lives, 'game/red_lives.png')
        score = 0
        ...
        if value['throw']:
            ...
            if not value['hit'] and current_position[0] > value['x'] and current_position[0] < value['x']+100 \
                ...
                if key == 'bomb':
                    ...
                    half_alien_path = "game/explosion.png"
                    explosion_sound.play()
                else:
                    half_alien_path = "game/" + "killed_" + key + ".png"
                    alien_screem.play()
